...
func NewUserStorage(gd data.GetterDeleter) model.UserStorage {
	return &UserStorage{
		gd: gd,
	}
}
...
func (pgu *UserStorage) Save(
	gtx context.Context, user *model.User) (err error) {
...
func (pgu *UserStorage) Update(
	gtx context.Context, user *model.User) error {
...
func (pgu *UserStorage) Get(
	...
	out := make([]*model.User, 0, params.PageSize)
